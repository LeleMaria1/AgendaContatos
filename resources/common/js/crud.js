...
function getFormularioInclusao() {
    ...
    form += '<div class="form-group">';
    form += '<label for="site" class="col-sm-2 control-label glyphicon glyphicon-star"></label>';
    form += '<div class="col-sm-8">';
    form += '<input type="text" class="form-control" id="site" placeholder="Site">';
    form += '</div>';
    form += '</div>';
